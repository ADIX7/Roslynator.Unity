...
{
    public class RR0151ReplaceWhileWithForTests : AbstractCSharpRefactoringVerifier
    {
        public override string RefactoringId { get; } = RefactoringIdentifiers.ReplaceWhileWithFor;

        [Fact, Trait(Traits.Refactoring, RefactoringIdentifiers.ReplaceWhileWithFor)]
